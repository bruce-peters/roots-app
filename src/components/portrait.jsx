    ...
    >
      {person.photo_url ? (
        <>
          ...
          />
          {/* Subtle warm sepia tint to keep the nostalgic palette */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background: 'rgba(120,72,30,0.18)',
      ...
      {person.photo_url ? (
        <>
          <img
            ...
            className="absolute inset-0 w-full h-full object-cover"
          />
          {/* Warm sepia + grain overlays to maintain the album aesthetic */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background: 'linear-gradient(180deg, rgba(120,72,30,0.12), rgba(50,28,12,0.38))',
              mixBlendMode: 'multiply',
            }}
          />
          <div
